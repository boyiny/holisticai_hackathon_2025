...
class AnimationController {
  ...
  public render() {
    ...
    // Scale up the entire spiral animation for a more striking effect
    ctx.scale(1.5, 1.5)
...
class Star {
  ...
  render(p: number, controller: AnimationController) {
    ...
    if (q > 0) {
      ...
      // Make particles significantly more prominent (≈4x original size)
      const dotSize = 8.5 * 4 * this.strokeWeightFactor * sizeMultiplier
