...
def main() -> None:
    parser = argparse.ArgumentParser(description="Chaos test: Valyu endpoint unavailable")
    ...
    parser.add_argument("--jitter-min", type=int, default=500)
    parser.add_argument("--jitter-max", type=int, default=1500)
    parser.add_argument("--net-fail-prob", type=float, default=0.3)
    parser.add_argument("--tool-fail-prob", type=float, default=0.3)
